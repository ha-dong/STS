...
<form id="login-form" class="form-signin">
    ...
    <button class="btn btn-lg btn-primary" type="submit">로그인</button> <!-- 버튼의 클래스에 btn-lg는 제거해도 됩니다 -->
<button id="kakao-login-btn">
    <img src="/StoryCraft/resources/img/KICON.png" alt="카카오 로그인 아이콘"> 카카오 로그인
</button>
<div class="options">
    ...
    <!-- 계정 복구 모달 -->
    <div id="reactivate-modal" class="modal modal-animation">
